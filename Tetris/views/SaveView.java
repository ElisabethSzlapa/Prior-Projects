...
public class SaveView {
    ...
    public void saveBoard() {
        ...
        SaveView content = new SaveView(tetrisView);
        if (!fileName.endsWith(".ser")) {
            System.out.println("Files must end in .ser!");
            return;
        }
        try {
            File myFile = new File("/Users/elisabeth/CSC207/szlapael/Assignment2/boards");
